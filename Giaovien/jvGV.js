...
function themghichuvaobangSK() {
  ...
  let tinhTrangSK =
    document.querySelector('input[name="suckhoe"]:checked')?.value || "";
  let ghiChuSK = document.getElementById("GhichuveTTSK").value;
  let cheDoAn =
    document.querySelector('input[name="BuaAN"]:checked')?.value || "";
...
function themghichuvaobangDS() {
  ...
  let LoaiDiem =
    document.querySelector('input[name="LD"]:checked')?.value || "";
  let Diemso = document.getElementById("txtDiemSODS").value;
